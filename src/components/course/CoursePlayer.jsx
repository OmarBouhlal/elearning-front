            ...
            <div className="p-5">
                ...
                <div className="flex gap-2 mb-5">
                    <a
                        href={course.pdfUrl}
                        download
                        className="w-full bg-blue-600 text-white font-bold py-2.5 px-4 rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30 flex items-center justify-center text-sm"
                    >
